...
// obtinere referința la elementul input
const validationInput = document.getElementById("validation-input");

// functia schimbare culoare chenar pe input
validationInput.addEventListener("blur", function () {
  // obtinere lungime text introdus în input
  const inputLength = validationInput.value.length;

  // obtinere nr corect de caractere din atributul data-length
  const requiredLength = parseInt(validationInput.getAttribute("data-length"));

  // verificare dacă lungimea textului introdus este corecta si adăugare clasele CSS aferente
